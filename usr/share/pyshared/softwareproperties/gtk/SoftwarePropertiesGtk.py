...
# using this often, so defining it here.
def permission_denied_dialog(parent_window):
    print("Warning: Authorization failed. Software sources can't be changed without permission.")
